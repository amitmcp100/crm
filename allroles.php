            ...
            <div class="content-header row mb-1">
                ...
                <div class="content-header-right col-md-6 col-12">
                    <div class="btn-group float-md-right" role="group" aria-label="Button group with nested dropdown">
                        <a href="user-roles.php" class="btn btn-info  box-shadow-2 px-2" ><i class="ft-plus icon-left"></i> Add Roles</a>
                    </div>
                </div> 
            </div>
                   <div class="row "> 
                                        ...
                                        <div class="table-responsive">
                                            <table class="table table-striped table-bordered zero-configuration">
                                                ...
                                                <tbody>
										        	...
										        	$sql1 = "SELECT *  FROM `tbl_user_roles` WHERE  store_id ='$store_id'";
													//echo $sql1;
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td><a href="editroles.php?id=<?php echo $id;?>" data-toggle="tooltip" title="EDIT" class="btn btn-success  box-shadow-2 mr-1 mb-1"><i class="ft-edit"></i></a>
                                                        <a href="deleteroles.php?id=<?php echo $id;?>" data-toggle="tooltip" title="DELETE" onclick="return confirm('Are you sure you want to delete this Roles?');" class="btn btn-warning  box-shadow-2 mr-1 mb-1"><i class="ft-delete"></i></a>
