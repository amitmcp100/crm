                                                 ...
                                                 // Date filter
                                                  ...
                                                  //echo "hello";
                                                   ...
                                                   $store_id = $_SESSION["store_id"];
                                                    ...
                                                    $sql1 = "SELECT *  FROM `tbl_customer_data` WHERE  'store_id' = '$store_id' and reminder='yes' and c_date between '".$fromDate."' and '".$endDate."'";
                                                    //echo $sql1;
                                                    ...
                                                    $sql1 = "SELECT *  FROM `tbl_customer_data` WHERE  store='$store_id' and reminder='yes'";
                                                    //echo $sql1;
                                                    $stmt = $DB->prepare($sql1);
                                                    $stmt->execute();
                                                    $stmt->setFetchMode(PDO::FETCH_ASSOC);
