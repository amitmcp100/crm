        ...
        <div class="content-wrapper">
            ...
            <div class="content-body">
               ...
               $usid=$_SESSION["user_id"];
                ...
                //include("configinc2.php");
                $sql11 = "SELECT *  FROM `tbl_user_group` WHERE `child_id` = '$userid'";
                //echo $sql;
                            ...
                            <div class="card">
                                ...
                                <div class="card-content collpase show">
                                    <div class="card-body">
                                        ...
                                        <form class="form form-horizontal" action="editsubuser_code.php" method="post">
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-6">
                                                        <div class="form-group row">
                                                            ...
                                                            <div class="col-md-9 mx-auto">
                                                                <input type="text" id="userinput2" class="form-control border-primary" placeholder="Last Name" name="lastname"   value="<?php if(!empty($last_name)){echo $last_name; }?>" >
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="row">
                                                    <div class="col-md-6">
                                                        <div class="form-group row">
                                                            ...
                                                            <div class="col-md-9 mx-auto">
                                                                <input type="text" id="userinput2" class="form-control border-primary" placeholder="Username" name="username"   value="<?php if(!empty($username)){echo $username; }?>"  required>
                                                            </div>
                                                        </div>
                                                     </div>
                                                    <div class="col-md-6">
                                                        <div class="form-group row">
                                                            ...
                                                            <div class="col-md-9 mx-auto">
                                                                <input type="password" id="userinput4" class="form-control border-primary" placeholder="New Password" name="pwd1" required >
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <div class="col-md-6">
                                                    ...
                                                    <div class="col-md-6">
                                                        <div class="form-group row">
                                                            ...
                                                            <div class="col-md-9 mx-auto">
                                                                <input type="text" id="userinput4" class="form-control border-primary" placeholder="Address" name="address" value="<?php if(!empty($address)){echo $address; }?>">
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <div class="col-md-6">
                                                        <div class="form-group row">
                                                            ...
                                                            <div class="col-md-9 mx-auto">
                                                                <input type="text" id="userinput4" class="form-control border-primary" placeholder="City" name="city" value="<?php if(!empty($city)){echo $city; }?>">
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <div class="col-md-6">
                           ...
                           <select class="form-control  border-primary" required="true" id="state" name="state"><option value="">Select State</option>
                            ...
                            <option value="Telangana" <?php if($state=='Telangana'){echo "selected";}?>>Telangana</option>
                                            ...
                                            <option value="">Select Roles</option>
                                             ...
                                             <?php 
                                                            $sql12 = "SELECT *  FROM `tbl_user_roles` WHERE `store` = '$store_id'";
                                                            ...
                                                            $roleid=$row12['id'];
                                                            ?>
                                                            <option value="<?php echo $roleid;?>" <?php if($roles_id==$roleid){echo "selected";} ?>><?php echo $rolename;?></option>
                                                            <?php
                                                            }
                                                            ?>
