                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group row">
                                                ...
                                                <div class="col-md-9 mx-auto">
                                                    <input type="text" id="userinput1" class="form-control border-primary" placeholder="Enter Package Name" name="package_name"   required>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                            <div class="form-group row">
                                                ...
                                                <div class="col-md-9 mx-auto">
                                                    <input type="text" id="name" class="form-control border-primary" placeholder="Enter Package Price" name="package_price"  >
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                     <div class="row">
                                        <div class="col-md-6">
                                            <div class="form-group row">
                                                ...
                                                <div class="col-md-9 mx-auto">
                                                    <input type="text" id="userinput1" class="form-control border-primary" placeholder="Enter Expiry of package" name="package_expiry">
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                                ...
                                                <div data-repeater-item>
                                                    <div class="form row">
                                                        ...
                                                        <div class="form-group mb-1 col-sm-12 col-md-4">
                                                            ...
                                                            <br>
                                                            <input type="text" class="form-control" name="package_qty" id="pass" placeholder="Quantity">
                                                        </div>
