...
class cleanto_dummy{
  ...
  public $week_days_available="ct_week_days_available";
	...
	public function add_users(){
		$query="insert into `".$this->users."` (`id`,`user_email`,`user_pwd`,`first_name`,`last_name`,`phone`,`zip`,`address`,`city`,`state`,`notes`,`vc_status`,`p_status`,`contact_status`,`status`,`usertype`,`cus_dt`,`stripe_id`) values(NULL,'".$this->u_user_email."','".$this->u_user_pwd."','".$this->u_first_name."','".$this->u_last_name."','".$this->u_phone."','".$this->u_zip."','".$this->u_address."','".$this->u_city."','".$this->u_state."','".$this->u_notes."','".$this->u_vc_status."','".$this->u_p_status."','".$this->u_contact_status."','".$this->u_status."','".$this->u_usertype."','".$this->u_cus_dt."','".$this->u_stripe_id."')";
		$result=mysqli_query($this->conn,$query);	
		$value=mysqli_insert_id($this->conn);
		return $value;
	}
