        ...
        <div class="content-wrapper">
            ...
            <div class="content-body">
               ...
               //include("configinc2.php");
                ...
                // Close connection
                $sql1 = "SELECT *  FROM `tbl_customer_group` WHERE `store_id` = '$store_id'  and `id` = '$id'";
                        ...
                        <div class="col-md-12">
                            <div class="card">
                                <div class="card-header">
                                    <h4 class="card-title" id="horz-layout-colored-controls">Add Customer Group</h4>
                                ...
                                <div class="card-content collpase show">
                                    <div class="card-body">
                                        ...
                                        <form class="form form-horizontal" action="updatecgroup.php" method="post">
                                        <input type="hidden" name="userid" value="<?php echo $_SESSION["user_id"];?>">
                                        <input type="hidden" name="store_id" value="<?php echo $store_id;?>">
                                        <input type="hidden" name="id" value="<?php echo $id;?>">
                                        
                                            <div class="form-body">
                                                <h4 class="form-section"><i class="la la-eye"></i> Add Customer Group</h4>
                                                <div class="row">
                                                    <div class="col-md-6">
                                                        <div class="form-group row">
                                                            <label class="col-md-3 label-control" for="userinput1">Name</label>
                                                            <div class="col-md-9 mx-auto">
                                                                <input type="text" id="userinput1" class="form-control border-primary" placeholder="Name" name="name"  value="<?php echo $name; ?>" required>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <div class="col-md-6">
                                                        <div class="form-group row">
                                                            ...
                                                            <div class="col-md-9 mx-auto">
                                                                <input type="text" id="userinput2" class="form-control border-primary" placeholder="Description" name="description"  value="<?php echo $description; ?>" >
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
