                        ...
                        <div class="col-12">
                            <div class="card">
                                ...
                                <div class="card-content collapse show">
                                    <div class="card-body ">
                                        <form class="form form-horizontal" action="editservices_code.php" method="post" name="uploadCSV" >
                                    <div class="form-body">
									...
									$id=$_GET['id'];
									$sql11 = "SELECT *  FROM `tbl_services` WHERE `id` = '$id' AND `store_id` ='$store_id'";
									//echo $sql;
                                    $stmt = $DB->prepare($sql11);
                                    $stmt->execute();
                                    $stmt->setFetchMode(PDO::FETCH_ASSOC);
                                    while ($row11 = $stmt->fetch()) {
									$service=$row11['service_name'];
									}
									?>
										...
										<input type="text" id="userinput1" class="form-control border-primary" placeholder="Service Name" name="service" value="<?php echo $service; ?>">
