                                        ...
                                        <div class="table-responsive">
                                            <table class="table table-striped table-bordered zero-configuration">
                                                ...
                                                <tbody>
													...
													$sql1 = "SELECT *  FROM `tbl_customer_data` WHERE  store='$store_id'";
													//echo $sql1;
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td></td>
                                                        <td><a href="editcustomer.php?id=<?php echo $id;?>" class="btn btn-success  box-shadow-2 mr-1 mb-1"><i class="ft-edit"></i></a>
                                                        </td>
