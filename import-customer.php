        ...
        <div class="content-wrapper">
            <div class="content-header row mb-1">
                <div class="content-header-left col-md-6 col-12 mb-2">
                    <h3 class="content-header-title">Customer Import</h3>
                    <div class="row breadcrumbs-top">
                        <div class="breadcrumb-wrapper col-12">
                            <ol class="breadcrumb">
                                <li class="breadcrumb-item"><a href="retailers.php">Home</a>
                                </li>
                                <li class="breadcrumb-item active">Customer Import
                                </li>
                            </ol>
                        </div>
                    </div>
                        ...
                        <div class="col-12">
                            <div class="card">
                                ...
                                <div class="card-content collapse show">
                                    <div class="card-body ">
                                        <form class="form form-horizontal" action="import_customercsv.php" method="post" name="uploadCSV" enctype="multipart/form-data">
                                    <div class="form-body">
                                    <h4 class="form-section"><i class="la la-upload"></i> Import Customer</h4>
                                    </div>
									<?php 
									...
									<div class="col-md-6">
									    <div class="form-group row">
									        <label class="col-md-3 label-control" for="userinput1">Choose CSV</label>
									        <div class="col-md-9 mx-auto">
									           <input type="file" name="file" id="file" accept=".csv">
									           <input type="hidden" name="store" value="<?php echo $store_id; ?>">
									           <input type="hidden" name="user" value="<?php echo $userid; ?>">
									           
									           <div style="margin-top:10px;"><button type="submit" id="submit" value="submit" name="import" class="btn btn-primary" >
