        ...
        <div class="content-wrapper">
            <div class="content-header row mb-1">
                <div class="content-header-left col-md-6 col-12 mb-2">
                    <h3 class="content-header-title">Birthday Management</h3>
                        ...
                        <div class="col-12">
                            <div class="card">
                                <div class="card-header">
                                    <h4 class="card-title">Birthday Management</h4>
                                            ...
                                            <table class="table table-striped table-bordered zero-configuration">
                                                ...
                                                <tbody>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td><a href="birthdaysms_code.php?id=<?php echo $id;?>" data-toggle="tooltip" title="SEND SMS NOW" class="btn btn-primary  box-shadow-2 mr-1 mb-1" onclick="return confirm('Are you sure you send SMS NOW ?');" ><i class="ft-message-circle"></i></a>
                                                        </td>
