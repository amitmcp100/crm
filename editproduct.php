                        ...
                        <div class="col-12">
                            <div class="card">
                                ...
                                <div class="card-content collapse show">
                                    <div class="card-body ">
                                        <form class="form form-horizontal" action="editproduct_code.php" method="post" name="uploadCSV" >
                                    <div class="form-body">
                                    <h4 class="form-section"><i class="la la-eye"></i> Edit Service</h4>
                                    </div>
									<?php 
									...
									$id=$_GET['id'];
									$sql11 = "SELECT *  FROM `tbl_product` WHERE `id` = '$id' and `store_id` = '$store_id'";
									//echo $sql;
                                    $stmt = $DB->prepare($sql11);
                                    $stmt->execute();
                                    $stmt->setFetchMode(PDO::FETCH_ASSOC);
                                    while ($row11 = $stmt->fetch()) {
                                    $product=$row11['product_name'];
                                    $price=$row11['price'];
									}
									...
									?>
										...
										<label class="col-md-3 label-control" for="userinput1">Product Name</label>
										    <div class="col-md-9 mx-auto">
                                                <input type="text" id="userinput1" class="form-control border-primary" placeholder="product Name" name="product" value="<?php echo stripslashes($product); ?>">
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group row">
                                                ...
                                                <div class="col-md-9 mx-auto">
                                                    <input type="text" id="userinput1" class="form-control border-primary" placeholder="Price" name="price" value="<?php echo $price;?>">
                                                </div>
                                            </div>
                                        </div>
