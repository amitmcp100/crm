        ...
        <div class="content-wrapper">
            <div class="content-header row mb-1">
                <div class="content-header-left col-md-6 col-12 mb-2">
                    <h3 class="content-header-title">Regain Setting</h3>
                    <div class="row breadcrumbs-top">
                        <div class="breadcrumb-wrapper col-12">
                            <ol class="breadcrumb">
                                <li class="breadcrumb-item"><a href="retailers.php">Home</a>
                                </li>
                                 <li class="breadcrumb-item active"><a href="#">Regain Setting</a>
                                </li>
                            </ol>
                        </div>
                    </div>
            ...
            <div class="content-body">
                ...
                <?php
                    $sql03 = "SELECT *  FROM `tbl_regain` where `store_id` = '$store_id'";
                    ...
                    $reminder = $row03['reminder'];
                    $duration =$row03['duration'];
                    $id = $row03['id'];
                    //echo$row02['duration'];
                    }
                }
                        ...
                        <div class="col-md-12">
                            <div class="card">
                                <div class="card-header">
                                    <h4 class="card-title" id="horz-layout-colored-controls">Regain Setting</h4>
                                ...
                                <div class="card-content collpase show">
                                    <div class="card-body">
                                    <form class="form form-horizontal" name="uploadimage"  action="regain_setting_code.php" enctype="multipart/form-data" method="post">
                                                ...
                                                <div class="col-md-9 mx-auto">
                                                     <select class="form-control  border-primary" id="duration"  name="duration">
                                                        <option selected="selected" value="">Select Time Duration</option>
                                                             ...
                                                             <option value="day" <?php if($duration == 'day') echo 'selected'; ?>>Days</option>
                                                             <option value="month"<?php if($duration == 'month') echo 'selected';?>>Months</option>
                                                             <option value="year"<?php  if($duration == 'year') echo 'selected'; ?>>Years</option>
                                                     </select>
                                                 </div>
                                            </div>
                                        </div>  
