                        ...
                        <div class="col-12">
                            <div class="card">
                                ...
                                <div class="card-content collapse show">
                                    <div class="card-body ">
                                        <form class="form form-horizontal" action="customersms_code.php" method="post" name="uploadCSV" >
                                    <div class="form-body">
									...
									$id=$_GET['id'];
									$sql1 = "SELECT *  FROM `tbl_customer_data` WHERE `id` = '$id' and `store_id` = '$store_id'";
									//echo $sql;
									    ...
									    <div class="form-group row">
									        ...
									        <?php echo $c_name;?>
									           ...
									           <input type="hidden" name="user" value="<?php echo $userid; ?>">
									            <input type="hidden" name="c_mobile" value="<?php echo $c_mobile; ?>">
									...
									<div class="form-group row">
									    ...
									    <div class="col-md-9 mx-auto">
									    <textarea name="sms_text" class="form-control textarea-maxlength" id="maxlength-textarea" placeholder="Enter upto 160 characters.." maxlength="159" rows="5" required=""></textarea>
									    </div>
									</div>
									</div>
