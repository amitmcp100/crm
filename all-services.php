        ...
        <div class="content-wrapper">
            <div class="content-header row mb-1">
                <div class="content-header-left col-md-6 col-12 mb-2">
                    <h3 class="content-header-title">All Services</h3>
                    <div class="row breadcrumbs-top">
                        <div class="breadcrumb-wrapper col-12">
                            <ol class="breadcrumb">
                                <li class="breadcrumb-item"><a href="retailers.php">Home</a>
                                </li>
                                <li class="breadcrumb-item active">All Services
                                </li>
                            </ol>
                        </div>
                    </div>
                                            ...
                                            <table class="table table-striped table-bordered zero-configuration">
                                                ...
                                                <tbody>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td><?php echo $row1['modi_date'];?></td>
                                                        <td >
                                                        <a href="editservices.php?id=<?php echo $id;?>"  data-toggle="tooltip" title="EDIT" class="btn btn-success  box-shadow-2 mr-1 mb-1"><i class="ft-edit"></i></a>
                                                       <form method="post" action="deleteservices.php">
