        ...
        <div class="content-wrapper">
            <div class="content-header row mb-1">
                <div class="content-header-left col-md-6 col-12 mb-2">
                    <h3 class="content-header-title">Package Management</h3>
                                                ...
                                                <tbody>
                                                   ...
                                                   // $name=$row1['name'];
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td><?php echo $row1['package_price'];?></td>
                                                        <td><?php echo $row1['package_expiry']." ".$row1['package_days'];?></td>
                                                        <td><?php echo $row1['create_date'];?></td>
                                                       
                                                        <td><a href="viewpackage.php?id=<?php echo $id;?>" data-toggle="tooltip" title="VIEW" class="btn btn-success  box-shadow-2 mr-1 mb-1"><i class="ft-eye"></i></a>
                                                        
                                                        <a href="deletepackage.php?id=<?php echo $id;?>" data-toggle="tooltip" title="DELETE" onclick="return confirm('Are you sure you want to delete this package?');" class="btn btn-warning  box-shadow-2 mr-1 mb-1"><i class="ft-delete"></i></a>
