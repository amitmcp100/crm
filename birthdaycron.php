...
while ($row1 = $stmt->fetch()) 
{
    ...
    $sqlbirthday = "SELECT mobile as bid FROM `tbl_customer_data` WHERE `dob` LIKE '%$cu_date%' and `store_id` = '$store_id'";
    ...
    $sql001 = "SELECT *  FROM `smstemplates` WHERE `message_type` = 'Birthday' and  `store_id` = '$store_id'";
    ...
    $sql4 = "SELECT *  FROM `tbl_customer_data` WHERE `store_id` = '$store_id' and `mobile` IN (".implode(',',$birthday_mobile).")";
    echo $sql4;
