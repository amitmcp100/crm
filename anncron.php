...
$sqlbirthday = "SELECT mobile as bid FROM `tbl_customer_data` WHERE `anniversary` LIKE '%$cu_date%'";
...
$business_name=$row12['business_name'];
 ...
 $sql001 = "SELECT *  FROM `smstemplates` WHERE `message_type` = 'Anniversary' and `store` = '0'";
