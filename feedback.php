            ...
            <div class="content-header row mb-1">
                ...
                <!-- <div class="content-header-right col-md-6 col-12">
                    <div class="btn-group float-md-right" role="group" aria-label="Button group with nested dropdown">
                        <a href="add-services.php" class="btn btn-info  box-shadow-2 px-2" ><i class="ft-plus icon-left"></i> Add Services</a>
                    </div>
                </div> -->
            </div>
                <div class="row "> 
                                        ...
                                        <div class="table-responsive">
                                            <table class="table table-striped table-bordered zero-configuration">
                                                ...
                                                <tbody>
													...
													$sql1 = "SELECT *  FROM `tbl_feedback` where `store_id` = '$store_id'";
													//echo $sql1;
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                       <?php if($row1['read']=='no'){?>
                                                        <a href="readfeedback.php?id=<?php echo $id;?>" alt="Read feedback" data-toggle="tooltip" title="READ FEEDBACK" class="btn alert-primary  box-shadow-2 mr-1 mb-1"><i class="ft-unlock" ></i></a><?php } else{?>
                                                        <a href="#" data-toggle="tooltip" title="ALREADY READ" class="btn btn-success  box-shadow-2 mr-1 mb-1"><i class="ft-lock"></i></a>
                                                        <?php } ?>
