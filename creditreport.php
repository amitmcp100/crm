        ...
        <div class="content-wrapper">
            <div class="content-header row mb-1">
                <div class="content-header-left col-md-6 col-12 mb-2">
                    <h3 class="content-header-title">SMS REPORT</h3>
                    <div class="row breadcrumbs-top">
                        <div class="breadcrumb-wrapper col-12">
                            <ol class="breadcrumb">
                                <li class="breadcrumb-item"><a href="retailers.php">Home</a>
                                </li>
                                <li class="breadcrumb-item active">SMS REPORT
                                </li>
                            </ol>
                        </div>
                    </div>
                                        ...
                                        <div class="table-responsive">
                                            <table class="table table-striped table-bordered zero-configuration">
                                                ...
                                                <tbody>
													...
													$sql1 = "SELECT *  FROM `sms_report` where `store_id` = '$store_id'";
													//echo $sql1;
                                                    ...
                                                    <tr>
                                                       ...
                                                       <td><?php echo $row1['from_date'];?></td>
                                                       <td><?php echo $row1['to_date'];?></td>
                                                       <td><?php echo $row1['state'];?></td>
                                                       <td><?php echo $row1['operator'];?></td>
                                                       <td><?php echo $row1['status'];?></td>
                                                       <td><?php echo $row1['send'];?></td>
                                                       <td><?php echo $row1['update_on'];?></td>
