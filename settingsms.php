        ...
        <div class="content-wrapper">
            <div class="content-header row mb-1">
                <div class="content-header-left col-md-6 col-12 mb-2">
                    <h3 class="content-header-title">SMS Settings</h3>
                    <div class="row breadcrumbs-top">
                        <div class="breadcrumb-wrapper col-12">
                            <ol class="breadcrumb">
                                <li class="breadcrumb-item"><a href="retailers.php">Home</a>
                                </li>
                                <li class="breadcrumb-item active">SMS Settings
                                </li>
                            </ol>
                        </div>
                    </div>
                ...
                <div class="content-header-right col-md-6 col-12">
                    <div class="btn-group float-md-right" role="group" aria-label="Button group with nested dropdown">
                        <a href="add-customer.php" class="btn btn-info  box-shadow-2 px-2" ><i class="ft-plus icon-left"></i>SMS Settings</a>
                    </div>
                </div>
            </div>
                   <div class="row "> 
                                        ...
                                        <div class="table-responsive">
                                            <table class="table table-striped table-bordered zero-configuration">
                                                ...
                                                <tbody>
													...
													$sql1 = "SELECT *  FROM `smstemplates` WHERE  store_id='$store_id'";
													//echo $sql1;
                                                   ...
                                                   // $name=$row1['name'];
													?>
                                                    <tr>
                                                        <td><?php echo $row1['message_type'];?></td>
                                                       
                                                       
                                                        <td><a href="editsettingsms.php?id=<?php echo $id;?>" data-toggle="tooltip" title="VIEW/EDIT" class="btn btn-success  box-shadow-2 mr-1 mb-1"><i class="ft-eye"></i></a>
